...
export const SignupScreen: React.FC = () => {
    ...
    return (
        <div className={`min-h-screen flex flex-col ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
            ...
            <div className="flex-1 flex items-center justify-center relative overflow-hidden px-4 sm:px-6 lg:px-8 py-12">
                {/* Background Assets */}
                ...
                <div className="absolute top-1/4 right-10 w-40 h-40 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
                <div className="absolute bottom-1/3 left-10 w-40 h-40 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
                    ...
                    <div className={`backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-10 ${darkMode ? 'bg-gray-800/60 border border-gray-700/50' : 'bg-white/70 border border-white/50'}`}>
                        <div className="text-center">
                            ...
                            <p className={`mt-2 text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                                Join thousands of developers building beautiful themes
                            </p>
                        </div>
                        ...
                        <div className="mt-8 space-y-6">
                            ...
                            <div className="text-center">
                                <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                                    ...
                                    <Link to="/login" className={`font-medium hover:underline ${darkMode ? 'text-indigo-400' : 'text-indigo-600'}`}>
                                        Sign in
                                    </Link>
                                </p>
                            </div>
