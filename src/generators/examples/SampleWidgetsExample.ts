    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: SingleChildScrollView(
          padding: EdgeInsets.all(${useScreenUtil ? 'AppConstants.paddingMedium' : '16.0'}),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              _buildCurrentThemeInfo(),
              SizedBox(height: ${useScreenUtil ? 'AppConstants.spacingLarge' : '24.0'}),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: ${useScreenUtil ? 'AppConstants.spacingSmall' : '8.0'}),
            Text(
              'This demonstrates the Material 3 theme system with all variants including accessibility-focused contrast modes.',
              style: theme.textTheme.bodyMedium,
            ),
            SizedBox(height: ${useScreenUtil ? 'AppConstants.spacingMedium' : '12.0'}),
            Wrap(
              spacing: ${useScreenUtil ? 'AppConstants.spacingSmall' : '8.0'},
              children: [
    ...
    return Chip(
      ...
      labelStyle: TextStyle(
        color: ThemeData.estimateBrightnessForColor(color) == Brightness.light
            ? Colors.black87
            : Colors.white,
        fontSize: ${useScreenUtil ? 'AppConstants.fontSizeSmall' : '12.0'},
      ),
    );
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              spacing: ${useScreenUtil ? 'AppConstants.spacingSmall' : '8.0'},
              runSpacing: ${useScreenUtil ? 'AppConstants.spacingSmall' : '8.0'},
              children: [
                ElevatedButton(
                  onPressed: () {},
                  child: Text('Elevated'),
              ...
              children: [
                Expanded(
                  child: Card(
                    elevation: 1,
                    child: Padding(
                      padding: EdgeInsets.all(${useScreenUtil ? 'AppConstants.paddingSmall' : '12.0'}),
                      child: Column(
                        children: [
                          Icon(Icons.lightbulb_outline, size: ${useScreenUtil ? 'AppConstants.iconSizeMedium' : '32.0'}),
                          SizedBox(height: ${useScreenUtil ? 'AppConstants.spacingSmall' : '8.0'}),
                ...
                SizedBox(width: ${useScreenUtil ? 'AppConstants.spacingSmall' : '8.0'}),
                Expanded(
                  child: Card(
                    elevation: 3,
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Icon(Icons.star_outline, size: ${useScreenUtil ? 'AppConstants.iconSizeMedium' : '32.0'}),
                          SizedBox(height: ${useScreenUtil ? 'AppConstants.spacingSmall' : '8.0'}),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text('Checkbox'),
                SizedBox(width: ${useScreenUtil ? 'AppConstants.spacingMedium' : '16.0'}),
